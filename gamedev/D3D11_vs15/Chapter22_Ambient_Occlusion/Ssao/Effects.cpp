...
{
	BasicFX           = new BasicEffect(device, L"FX/Basic_Ssao.cso");
	NormalMapFX       = new NormalMapEffect(device, L"FX/NormalMap_Ssao.cso");
	DisplacementMapFX = new DisplacementMapEffect(device, L"FX/DisplacementMap_Ssao.cso");
	BuildShadowMapFX  = new BuildShadowMapEffect(device, L"FX/BuildShadowMap_Ssao.cso");
	SsaoNormalDepthFX = new SsaoNormalDepthEffect(device, L"FX/SsaoNormalDepth_Ssao.cso");
	SsaoFX            = new SsaoEffect(device, L"FX/Ssao_Ssao.cso");
	SsaoBlurFX        = new SsaoBlurEffect(device, L"FX/SsaoBlur_Ssao.cso");
	SkyFX             = new SkyEffect(device, L"FX/Sky_Ssao.cso");
	DebugTexFX        = new DebugTexEffect(device, L"FX/DebugTexture_Ssao.cso");
}
