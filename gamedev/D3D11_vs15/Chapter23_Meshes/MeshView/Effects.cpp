...
{
	BasicFX           = new BasicEffect(device, L"FX/Basic_MeshView.cso");
	NormalMapFX       = new NormalMapEffect(device, L"FX/NormalMap_MeshView.cso");
	BuildShadowMapFX  = new BuildShadowMapEffect(device, L"FX/BuildShadowMap_MeshView.cso");
	SsaoNormalDepthFX = new SsaoNormalDepthEffect(device, L"FX/SsaoNormalDepth_MeshView.cso");
	SsaoFX            = new SsaoEffect(device, L"FX/Ssao_MeshView.cso");
	SsaoBlurFX        = new SsaoBlurEffect(device, L"FX/SsaoBlur_MeshView.cso");
	SkyFX             = new SkyEffect(device, L"FX/Sky_MeshView.cso");
	DebugTexFX        = new DebugTexEffect(device, L"FX/DebugTexture_MeshView.cso");
}
