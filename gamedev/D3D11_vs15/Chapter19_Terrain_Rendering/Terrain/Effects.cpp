...
{
	BasicFX = new BasicEffect(device, L"FX/Basic_Terrain.cso");
	SkyFX   = new SkyEffect(device, L"FX/Sky_Terrain.cso");
	TerrainFX = new TerrainEffect(device, L"FX/Terrain_Terrain.cso");
}
