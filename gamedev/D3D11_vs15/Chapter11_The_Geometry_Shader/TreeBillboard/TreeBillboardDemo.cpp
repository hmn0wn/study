...
bool TreeBillboardApp::Init()
{
    ...
    HR(DirectX::CreateDDSTextureFromFile(md3dDevice, L"Textures/grass.dds", &texRes, &mGrassMapSRV));
...
DirectX::XMFLOAT3 TreeBillboardApp::GetHillNormal(float x, float z)const
{
    // n = (-df/dx, 1, -df/dz)
    DirectX::XMFLOAT3 n(
...
void TreeBillboardApp::DrawTreeSprites(DirectX::CXMMATRIX viewProj)
{
