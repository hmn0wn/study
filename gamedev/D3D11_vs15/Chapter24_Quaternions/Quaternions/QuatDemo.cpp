  ...
  mSkullIndexCount(0), mAnimTimePos(0.0f)
{
	...
	DirectX::XMVECTOR q0 = DirectX::XMQuaternionRotationAxis(DirectX::XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f), DirectX::XMConvertToRadians(30.0f));
	DirectX::XMVECTOR q1 = DirectX::XMQuaternionRotationAxis(DirectX::XMVectorSet(1.0f, 1.0f, 2.0f, 0.0f), DirectX::XMConvertToRadians(45.0f));
	DirectX::XMVECTOR q2 = DirectX::XMQuaternionRotationAxis(DirectX::XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f), DirectX::XMConvertToRadians(-30.0f));
	DirectX::XMVECTOR q3 = DirectX::XMQuaternionRotationAxis(DirectX::XMVectorSet(1.0f, 0.0f, 0.0f, 0.0f), DirectX::XMConvertToRadians(70.0f));
