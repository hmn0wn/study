...
{
	BasicFX        = new BasicEffect(device, L"FX/Basic_TesselationDemo.cso");
	BlurFX         = new BlurEffect(device, L"FX/Blur_TesselationDemo.cso");
	TessellationFX = new TessellationEffect(device, L"FX/Tessellation_TesselationDemo.cso");
}
