...
{
	BasicFX              = new BasicEffect(device, L"FX/Basic_BezierPath.cso");
	BlurFX               = new BlurEffect(device, L"FX/Blur_BezierPath.cso");
	BezierTessellationFX = new BezierTessellationEffect(device, L"FX/BezierTessellation_BezierPath.cso");
}
