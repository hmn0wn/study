...
{
	BasicFX           = new BasicEffect(device, L"FX/Basic_NDMap.cso");
	NormalMapFX       = new NormalMapEffect(device, L"FX/NormalMap_NDMap.cso");
	DisplacementMapFX = new DisplacementMapEffect(device, L"FX/DisplacementMap_NDMap.cso");
	SkyFX             = new SkyEffect(device, L"FX/Sky_NDMap.cso");
}
