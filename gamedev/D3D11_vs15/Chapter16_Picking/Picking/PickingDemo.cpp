...
void PickingApp::BuildMeshGeometryBuffers()
{
    ...
    XMStoreFloat3(&mMeshBox.Center, DirectX::XMVectorScale(DirectX::XMVectorAdd(vMin, vMax), 0.5f));
    XMStoreFloat3(&mMeshBox.Extents, DirectX::XMVectorScale(DirectX::XMVectorSubtract(vMax,vMin), 0.5f));
