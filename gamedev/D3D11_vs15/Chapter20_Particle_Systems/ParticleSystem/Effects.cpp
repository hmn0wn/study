...
{
	BasicFX = new BasicEffect(device, L"FX/Basic_Particle.cso");
	SkyFX   = new SkyEffect(device, L"FX/Sky_Particle.cso");
	TerrainFX = new TerrainEffect(device, L"FX/Terrain_Particle.cso");
	FireFX = new ParticleEffect(device, L"FX/Fire_Particle.cso");
	RainFX = new ParticleEffect(device, L"FX/Rain_Particle.cso");
}
