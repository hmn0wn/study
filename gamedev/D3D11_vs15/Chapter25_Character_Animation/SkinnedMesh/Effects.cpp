...
{
	BasicFX           = new BasicEffect(device, L"FX/Basic_SkinnedMesh.cso");
	NormalMapFX       = new NormalMapEffect(device, L"FX/NormalMap_SkinnedMesh.cso");
	BuildShadowMapFX  = new BuildShadowMapEffect(device, L"FX/BuildShadowMap_SkinnedMesh.cso");
	SsaoNormalDepthFX = new SsaoNormalDepthEffect(device, L"FX/SsaoNormalDepth_SkinnedMesh.cso");
	SsaoFX            = new SsaoEffect(device, L"FX/Ssao_SkinnedMesh.cso");
	SsaoBlurFX        = new SsaoBlurEffect(device, L"FX/SsaoBlur_SkinnedMesh.cso");
	SkyFX             = new SkyEffect(device, L"FX/Sky_SkinnedMesh.cso");
	DebugTexFX        = new DebugTexEffect(device, L"FX/DebugTexture_SkinnedMesh.cso");
}
