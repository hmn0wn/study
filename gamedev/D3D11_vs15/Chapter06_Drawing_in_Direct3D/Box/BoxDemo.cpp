...
: D3DApp(hInstance), mBoxVB(0), mBoxIB(0), mFX(0), mTech(0),
  mfxWorldViewProj(0), mInputLayout(0), mNoCullRS(0),
...
void BoxApp::BuildFX()
{
    ...
    HRESULT hr = D3DCompileFromFile(L"FX/box_color.fx", 0, 0, 0, "fx_5_0", shaderFlags,
    ...
    if(FAILED(hr))
    {
        DXTrace(__FILEW__, (DWORD)__LINE__, hr, L"D3DCompileFromFile", false); //true - error message, false - to output
    }
