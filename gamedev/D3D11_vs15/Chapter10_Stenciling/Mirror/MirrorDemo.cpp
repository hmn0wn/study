...
bool MirrorApp::Init()
{
	...
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, L"Textures/checkboard.dds", &texRes, &mFloorDiffuseMapSRV));

	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, L"Textures/brick01.dds", &texRes, &mWallDiffuseMapSRV));

	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, L"Textures/ice.dds", &texRes, &mMirrorDiffuseMapSRV));
