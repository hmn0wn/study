...
{
	BasicFX           = new BasicEffect(device, L"FX/Basic_Shadows.cso");
	NormalMapFX       = new NormalMapEffect(device, L"FX/NormalMap_Shadows.cso");
	DisplacementMapFX = new DisplacementMapEffect(device, L"FX/DisplacementMap_Shadows.cso");
	BuildShadowMapFX  = new BuildShadowMapEffect(device, L"FX/BuildShadowMap_Shadows.cso");
	SkyFX             = new SkyEffect(device, L"FX/Sky_Shadows.cso");
	DebugTexFX        = new DebugTexEffect(device, L"FX/DebugTexture_Shadows.cso");
}
